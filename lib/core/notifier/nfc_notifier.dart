  ...
  NdefMessage _createNdefMessage({required String dataType}) {
    switch (dataType) {
      case 'URL':
        {
          return NdefMessage([
            NdefRecord.createUri(
              Uri.parse("https://www.aiopcpl.in"), // Change to your website
            ),
          ]);
        }
      case 'MAIL':
        {
          String emailData = 'mailto:vaishnavi.kausale@aiopcpl.in'; // Change to your email
          return NdefMessage(
            [
              NdefRecord.createUri(
                Uri.parse(emailData),
      ...
      case 'CONTACT':
        {
          String contactData =
              'BEGIN:VCARD\nVERSION:2.1\nN:Vaishnavi Kausale\nTEL:+1234567890\nEMAIL:vaishnavi.kausale@aiopcpl.in\nEND:VCARD'; // Change to your info
